      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <p> Lý do hủy đơn : <span><?= $fetch_orders['note']; ?></span> </p>
                  <form action="" method="POST">
                     <div class="flex-btn">
                        <a href="pllaced_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">Xóa</a>
                     </div>
                  </form>
               </div>
         <?php
