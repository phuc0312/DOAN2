...
if (isset($_GET['delete'])) {
    ...
    header('location:orders_finish.php');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="show-products" style="padding-top: 0;">
        ...
        <table class="table-category">
            ...
            <tbody>
                <?php
                $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE payment_status = 'finish' ORDER BY placed_on DESC");
                ...
                ?>
                        ...
                        <td><?= $fetch_orders['id']; ?></td>
                            ...
                            <td>
                                <a href="placed_orders.php?placed=<?= $fetch_orders['id']; ?>" class="placed" >Chi tiết </a>
                            </td>
                            <td>
                                <div class="flex-btn">
