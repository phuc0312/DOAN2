...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 13, 2023 lúc 03:35 AM
...
(66, 32, '2023-12-08 08:11:56', '::1'),
(67, 11, '2023-12-08 08:16:31', '::1'),
(68, 32, '2023-12-08 08:24:48', '::1');
...
(63, 80, 'Nguyễn Văn Hiếu', '0902222222', 'Phuc7951936@gmail.com', 'VNPAY', 'số 62, đường 3/2, khóm1, , , ', 'Bánh croisant (30000 x 2) - Trà sữa socola (30000 x 5) - ', 189000, 21000, '2023-12-08 15:29:24', 'finish', 'paid', NULL);
...
(35, 'Bánh croisant', 'Đồ ăn nhanh', 30000, 171, 'Bánh sừng bò còn được gọi là bánh croa-xăng, có nguồn gốc từ Áo, là một dạng bánh ăn sáng làm từ pâte feuilletée, được sản xuất từ bột mì, men, bơ, sữa, và muối. Bánh croissant đúng kiểu phải thật xốp, giòn và có thể xé ra từng lớp mỏng nhỏ. Bên trong ruộ', 'cr5.jpg'),
...
(39, 'Trà sữa socola', 'Trà sữa', 30000, 178, 'Trà sữa trân châu socola sẽ là một gợi ý hay để bạn thể hiện tình yêu đong đầy với nửa kia của mình.', 'socola2.jpg'),
...
(80, 'Nguyễn Văn Hiếu', 'Phuc7951936@gmail.com', '0902222222', '7c222fb2927d828af22f592134e8932480637c0d', 'số 62, đường 3/2, khóm1, , , ', 'active', NULL, NULL, NULL);
...
(16, 79, '2023-12-08 08:12:09', '::1'),
(17, 80, '2023-12-08 08:22:47', '::1');
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
